...
Collapse: {
    bCollapse: () => import(/* webpackChunkName: "vue-bootstrap-collapse" */ 'bootstrap-vue/es/components/collapse/collapse'),
        use: {
        togglePlugin: require('bootstrap-vue/es/directives/toggle')
    }
},
Dropdown: {
...
Modal: {
    bModal: () => import(/* webpackChunkName: "vue-bootstrap-modal" */ 'bootstrap-vue/es/components/modal/modal'),
        use: {
        modalPlugin: require('bootstrap-vue/es/directives/modal')
    }
},
Nav: {
...
const directives = {
    Toggle: require('bootstrap-vue/es/directives/toggle'),
    Modal: require('bootstrap-vue/es/directives/modal'),
    Scrollspy: require('bootstrap-vue/es/directives/scrollspy'),
    Tooltip: require('bootstrap-vue/es/directives/tooltip'),
    Popover: require('bootstrap-vue/es/directives/popover')
}
